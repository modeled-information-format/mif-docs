...
<!--
MIF Level 1 (floor): id, type, created + body. A complete, valid executive
summary — but opaque to a machine consumer. It cannot be queried for "is this
summary still current for the decision it supports?", "where did the evidence
come from?", or "what fuller report does this summarize?". Compare
