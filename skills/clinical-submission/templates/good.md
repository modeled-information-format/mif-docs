...
namespace: clinical-submission/cardiovascular
title: 'Clinical Study Report: CARDIA-3 — A Phase III Trial of Cortivex in Essential Hypertension'
tags:
...
provenance:
  ...
  trustLevel: verified
  wasGeneratedBy:
    '@id': urn:mif:activity:cardia3-csr-authoring-2026-06-30
    '@type': prov:Activity
citations:
  - '@type': Citation
...
relationships:
  - type: relates-to
    target: /semantic/academic/cardia3-journal-manuscript.md
ontology:
...
entity:
  name: 'Clinical Study Report: CARDIA-3 — A Phase III Trial of Cortivex in Essential Hypertension'
  entity_type: clinical-study-report
---
