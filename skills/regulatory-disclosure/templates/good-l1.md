...
```mermaid
xychart-beta
    title "Solara Grid Systems — Annual Revenue"
...
<!--
MIF Level 1 (floor): id, type, created + body. A complete, valid disclosure
report in fixed Reg S-K item order — but opaque to a machine consumer. It
cannot be queried for "is this the current filing?", "where did each disclosed
fact come from?", or "what does this relate to?". Compare templates/good.md
(full L3: temporal validity, W3C-PROV provenance, per-claim citations, typed
