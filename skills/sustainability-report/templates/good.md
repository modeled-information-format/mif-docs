...
namespace: sustainability-report/apparel
title: 'Solvane Textiles Group — Sustainability Report 2025'
tags:
...
provenance:
  ...
  trustLevel: verified
  wasGeneratedBy:
    '@id': urn:mif:activity:sustainability-report-2025-compilation
    '@type': prov:Activity
citations:
  - '@type': Citation
  ...
  - '@type': Citation
    citationType: documentation
    citationRole: methodology
    title: GRI Universal Standards (GRI 1, GRI 2, GRI 3)
    url: https://www.globalreporting.org/standards/standards-development/universal-standards/
    accessed: '2026-06-26'
  - '@type': Citation
    citationType: documentation
    citationRole: methodology
    title: GRI Topic Standards (GRI 200/300/400 series)
    url: https://www.globalreporting.org/standards/standards-development/topic-standards/
    accessed: '2026-06-26'
relationships:
  - type: relates-to
    target: /semantic/regulatory-disclosure/regulatory-disclosure-solvane-textiles-2025.md
ontology:
...
entity:
  name: 'Solvane Textiles Group — Sustainability Report 2025'
  entity_type: sustainability-report
---
...
```mermaid
quadrantChart
    title Materiality Assessment 2025
    x-axis Lower stakeholder concern --> Higher stakeholder concern
    y-axis Lower business impact --> Higher business impact
    quadrant-1 Material — priority
    quadrant-2 Monitor
    quadrant-3 Track
    quadrant-4 Manage
    Water stewardship: [0.85, 0.90]
    Labor conditions: [0.90, 0.85]
    Packaging waste: [0.55, 0.45]
    Supplier emissions: [0.60, 0.65]
```
